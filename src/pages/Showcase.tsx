...
const Showcase = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0] text-[#3A4750] font-lato">
      ...
      {/* Header Banner */}
      <div className="relative bg-[#3A4750] text-white py-32 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-merriweather text-4xl md:text-5xl mb-6">The Blossoms of My Garden</h1>
            ...
            <CardContent>
              <div className="flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-1/2">
                  <div className="aspect-video bg-[#3A4750]/10 rounded-lg flex items-center justify-center mb-4">
                    [TODO: Add screenshot of portfolio website]
                  </div>
                  <div className="aspect-video bg-[#3A4750]/10 rounded-lg flex items-center justify-center">
            ...
            <CardContent>
              <div className="flex flex-col md:flex-row gap-8">
                <div className="w-full md:w-1/2">
                  ...
                  <div className="bg-[#F0F0F0] p-6 rounded-lg mb-6">
                    <h4 className="font-merriweather text-lg font-semibold mb-3 text-[#F6C90E] bg-[#3A4750] p-2 inline-block rounded">L — Listening</h4>
                    <p className="mb-2">
                    ...
                    <h4 className="font-merriweather text-lg font-semibold mb-3 mt-4 text-[#F6C90E] bg-[#3A4750] p-2 inline-block rounded">I — Integration</h4>
                    <p className="mb-2">
                    ...
                    <h4 className="font-merriweather text-lg font-semibold mb-3 mt-4 text-[#F6C90E] bg-[#3A4750] p-2 inline-block rounded">F — Feedback</h4>
                    <p className="mb-2">
                    ...
                    <h4 className="font-merriweather text-lg font-semibold mb-3 mt-4 text-[#F6C90E] bg-[#3A4750] p-2 inline-block rounded">E — Emergence</h4>
                    <p>
                ...
                <div className="w-full md:w-1/2">
                  <div className="aspect-square bg-[#3A4750] rounded-lg flex items-center justify-center mb-6">
                    ...
                    <div className="relative w-4/5 h-4/5">
                      ...
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#F6C90E] text-[#3A4750] w-16 h-16 rounded-full flex items-center justify-center font-bold">L</div>
                      
                      <div className="absolute right-0 top-1/2 transform translate-x-1/2 -translate-y-1/2 bg-[#F6C90E] text-[#3A4750] w-16 h-16 rounded-full flex items-center justify-center font-bold">I</div>
                      
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-[#F6C90E] text-[#3A4750] w-16 h-16 rounded-full flex items-center justify-center font-bold">F</div>
                      
                      <div className="absolute left-0 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#F6C90E] text-[#3A4750] w-16 h-16 rounded-full flex items-center justify-center font-bold">E</div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="bg-white border-t-4 border-t-[#F6C90E]">
              <CardHeader>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-[#F0F0F0] p-8 rounded-lg mb-8">
            <p className="text-center mb-6">[TODO: Embed or link resume]</p>
            
            <Button className="bg-[#3A4750] text-white hover:bg-[#3A4750]/90">
              Download Resume (PDF)
            </Button>
          </div>
