      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          ...
          <div className="container relative z-10 text-center px-4 md:px-0">
            <h1 
              id="hero-heading" 
              className="font-merriweather text-4xl md:text-6xl text-white mb-6 leading-tight animate-fade-in"
            >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                ...
                aria-label="Explore my garden - go to introduction section"
              >
                Explore My Garden <ChevronDown className="ml-2 h-5 w-5" aria-hidden="true" />
              </Button>
              <Link to="/showcase" aria-label="View my showcase page">
                <Button
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="relative pl-8 border-l-2 border-[#F6C90E] mb-10">
              <div className="absolute -left-3 top-0 w-6 h-6 rounded-full bg-[#F6C90E]" aria-hidden="true"></div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row gap-10 items-center">
              <div className="w-full md:w-1/2">
                <div className="aspect-square rounded-full bg-[#3A4750] relative overflow-hidden" aria-hidden="true">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
              <div>
                <h3 id="cultivated-skills-heading" className="font-merriweather text-2xl mb-6 text-center border-b-2 border-[#F6C90E] pb-2">
                  Cultivated (Transferable) Skills
                </h3>
                <div className="grid grid-cols-1 gap-4" role="list" aria-labelledby="cultivated-skills-heading">
                  <SkillCard 
              ...
              <div>
                <h3 id="emerging-skills-heading" className="font-merriweather text-2xl mb-6 text-center border-b-2 border-[#F6C90E] pb-2">
                  Emerging (Technical) Skills
                </h3>
                <div className="grid grid-cols-1 gap-4" role="list" aria-labelledby="emerging-skills-heading">
                  <SkillCard 
        ...
        <Section 
          ...
          className="bg-white"
          aria-labelledby="showcase-link-heading"
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/showcase" aria-label="Explore my showcase page">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
              ...
              <Button 
                className="bg-[#3A4750] text-white hover:bg-[#3A4750]/90 w-full py-6"
